...
<head>
  ...
  <title>Xem phiếu xuất - WEARLY</title>
  <style>
    :root {
      --dark: #000;
      --green: #a8d5ba;
  ...
  <div class="layout">
    ...
    <div class="main-content">
      <div class="detail-card">
        <div class="detail-title">Xem phiếu xuất MPX003</div>
        <div class="info-grid">
          <div class="info-row">
            <div class="info-label">Mã phiếu xuất</div>
            <div class="info-value">MPX003</div>
        ...
        <div class="action-bar">
          <a href="{{ url('/stockout-index1') }}" class="btn-sub">Quay lại</a>
...
<script>
  ...
  document.getElementById('editBtn').onclick = function() {
    window.location.href = "{{ url('/stockout-edit') }}";
  }
</script>
</body>
</html>
